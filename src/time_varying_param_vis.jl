...
function time_varying_param_vis(
    ...
    println("Generating time varying parameter plots (with wastewater and time-varying hospitalization probability - prevalence model)...")
    chains = unique(gq_samples.chain)
    samples = fit(
        data_hosp,
        data_wastewater,
...
function time_varying_param_vis(
    ...
    println("Generating time varying parameter plots (with wastewater and time-varying hospitalization probability - incidence model)...")
    chains = unique(gq_samples.chain)
    samples = fit(
        data_hosp,
        data_wastewater,
