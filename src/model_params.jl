...
struct model_params_hosp_inc_prev
    ...
    sigma_ww_sd::Float64
    log_sigma_ww_mean::Float64
    sigma_hosp_prev_sd::Float64
    log_sigma_hosp_prev_mean::Float64
    sigma_hosp_inc_sd::Float64
    log_sigma_hosp_inc_mean::Float64
...
function create_model_params_hosp_inc_prev(
    ...
    sigma_ww_sd::Float64, log_sigma_ww_mean::Float64,
    sigma_hosp_prev_sd::Float64, log_sigma_hosp_prev_mean::Float64,
    sigma_hosp_inc_sd::Float64, log_sigma_hosp_inc_mean::Float64,
    ...
    return model_params_hosp_inc_prev(
        ...
        sigma_ww_sd, log_sigma_ww_mean,
        sigma_hosp_prev_sd, log_sigma_hosp_prev_mean,
        sigma_hosp_inc_sd, log_sigma_hosp_inc_mean,
