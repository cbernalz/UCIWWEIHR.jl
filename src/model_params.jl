...
"""
    model_params_non_time_var_hosp

Struct for holding parameters used in the UCIWWEIHR ODE compartmental model.  Use `create_model_params_non_time_var_hosp` to create an instance of this struct.
...
"""
struct model_params_non_time_var_hosp
    E_init_sd::Float64
    log_E_init_mean::Float64
    I_init_sd::Float64
    log_I_init_mean::Float64
...
function create_model_params_non_time_var_hosp(
    ...
    if message
        println("Using model without time-varying hospitalization probability!!!") 
    end

    return model_params_non_time_var_hosp(
        E_init_sd, log_E_init_mean,
        I_init_sd, log_I_init_mean,
        H_init_sd, log_H_init_mean,
        gamma_sd, log_gamma_mean,
...
"""
    model_params_time_var_hosp_no_ww

Struct for holding parameters used in the UCIWWEIHR ODE compartmental model without wastewater.  Use `create_model_params_time_var_hosp_no_ww` to create an instance of this struct.
This will use a time-varying hospitalization probability.
...
- `sigma_w_mean::Float64=-3.5`: Mean for normal prior of time-varying hospitalization rate standard deviation.
"""
struct model_params_time_var_hosp_no_ww
    E_init_sd::Float64
    log_E_init_mean::Float64
    I_init_sd::Float64
    log_I_init_mean::Float64
...
function create_model_params_time_var_hosp(
    ...
    if message
        println("Using time-varying hospitalization probability w/out wastewater!!!") 
    end

    return model_params_time_var_hosp_no_ww(
        E_init_sd, log_E_init_mean,
        I_init_sd, log_I_init_mean,
        H_init_sd, log_H_init_mean,
        gamma_sd, log_gamma_mean,
