...
Struct for holding parameters used in the UCIWWEIHR ODE compartmental model.  Use `create_uciwweihr_model_params` to create an instance of this struct.  With hard coded sigma_wastewater and sigma_hosp.
...
Struct for holding parameters used in the UCIWWEIHR ODE compartmental model.  Use `create_uciwweihr_model_params` to create an instance of this struct.  With prior on sigma_wastewater and sigma_hosp.
...
"""
    create_uciwweihr_model_params1(; kwargs...) or create_uciwweihr_model_params2(; kwargs...)

Creates a `uciwweihr_sim_params1` or `uciwweihr_sim_params2` struct with the option to either hard code sigma_wastewater and sigma_hosp or provide a prior.
