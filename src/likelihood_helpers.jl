...
function likelihood_helpers(
    ...
    # model w/ time-varying hosp prob and w/out wastewater
    try
        # Non-constant Rt
        sigma_Rt_non_centered = Rt_params_non_centered[1]
        Rt_init_non_centered = Rt_params_non_centered[2]
...
function likelihood_helpers(
    ...
    # model w/ non time-varying hosp prob and w/ wastewater
    try
        # Non-constant Rt
        sigma_Rt_non_centered = Rt_params_non_centered[1]
        Rt_init_non_centered = Rt_params_non_centered[2]
...
function likelihood_helpers(
    ...
    # model w/ non time-varying hosp prob and w/out wastewater
    try
        # Non-constant Rt
        sigma_Rt_non_centered = Rt_params_non_centered[1]
        Rt_init_non_centered = Rt_params_non_centered[2]
